...
SDK. **55 tools** across input, screen, window, UI automation, process/shell,
...
| File | `file_search`, `file_manage`, `file_dialog`, `file_read`, `file_write`, `file_info`, `file_hash`, `archive` |
